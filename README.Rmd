...
[![Test coverage](https://github.com/frbcesab/ecoclassifyr/actions/workflows/test-coverage.yaml/badge.svg)](https://github.com/frbcesab/ecoclassifyr/actions/workflows/test-coverage.yaml)
...
The main purpose of `ecoclassifyr` is to... **{{ DESCRIBE THE MAIN FEATURES }}**
...
[Get started](https://frbcesab.github.io/ecoclassifyr/articles/ecoclassifyr.html)
vignette.
...
`ecoclassifyr` provides **{{ NUMBER OF VIGNETTES }}** vignettes to learn more about the package:

- the [Get started](https://frbcesab.github.io/ecoclassifyr/articles/ecoclassifyr.html)
...
> Casajus Nicolas (`r format(Sys.Date(), "%Y")`) ecoclassifyr: An R 
...
check out our [Contributor Guidelines](https://github.com/frbcesab/ecoclassifyr/blob/main/CONTRIBUTING.md).
